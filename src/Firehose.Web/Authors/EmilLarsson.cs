...
namespace Firehose.Web.Authors
{
    public class EmilLarsson : IAmACommunityMember
    {
        ...
        public string ShortBioOrTagLine => "is a PowerShell loving hybrid identity expert, blog about PowerShell solutions in Windows Server Core, Active Directory, Azure AD, .NET";
